...
obj/admins/proc/Edit(atom/A in world)
	...
	alertAdmins("[key_name(usr)] begins to edit [key_name(A)].</b>")
					...
					if("edit")
						...
						if(Y)
							...
							if((ckey(W) in list("client","type","parent_type"))||((isarea(O)||isturf(O))&&ckey(W)=="loc")) html+="This variable is not allowed to be edited"
								...
								alertAdmins("[usr.key] modified [O.name]'s [W] [X] ([DetermineVarType(X)]) to [O.vars[W]] ([DetermineVarType(O.vars[W])])",2)
